...
var trailer= document.getElementsByClassName("watch");

trailer[0].onclick= function(){
    if(card.className === "watchTrailer"){
        card.classList.add("watchTrailerOpen");
    }
    else{
        card.className = "watchTrailer";
    }
}